...
Além dos recursos utilizados, outra parte importante para o desenvolvimento deste, são as seguintes etapas: 

\begin{alineas}	
	\item Revisão bibliográfica: Nos dará a base para que possamos compreender a gerência de projetos tradicional e ágil.
	\item Análise das práticas do PMBOK: Esta etapa tem por objetivo reunir informações acerca das práticas do PMBOK....
