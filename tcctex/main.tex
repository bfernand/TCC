...
A estrutura acima e seu desenvolvimento ao londo do tempo pode ser ilustrada pela Figura 1, que mostra o nível de esforço e custo de cada fase.
...
A Figura 2 mostra o esforço necessário em cada grupo de processo ao longo do ciclo de vida do projeto e a sobreposição entre os grupos.

\begin{figure}[htb]
\RawFloats
	\caption{\label{fig_grupo_processos}Interação entre os grupos de processos do PMBOK}
	\begin{center}
