...
A engenharia de software é uma disciplina que se preocupa com todos os aspectos da produção do software por isto é tão importante para o desenvolvimento deste. É através da Engenharia que o software pode ser construído com qualidade \cite[p.~3]{sommerville2011}. Para \citeonline[p.~39]{pressman2011}, engenharia de software é uma tecnologia em camadas com foco na qualidade e as camadas desta tecnologia são: Processos, métodos e ferramentas, sendo que o primeiro é o alicerce da engenharia de software.

Para \citeonline[p.~52]{pressman2011}, um processo de software é uma metodologia, sequência de passos previsíveis ou um roteiro, para as atividades, ações e tarefas necessárias para o desenvolvimento de um software de alta qualidade. 
