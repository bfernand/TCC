...
A engenharia de software é uma disciplina que se preocupa com todos os aspectos da produção do software \cite[p.~3]{sommerville2011}. Para \citeonline[p.~39]{pressman2011}, engenharia de software é uma tecnologia em camadas com foco na qualidade e as camadas desta tecnologia são: Processos (sendo o alicerce), métodos e ferramentas.

Outra definição importante também é apresentada por \citeonline[p.~52]{pressman2011}, que diz que um processo de software é uma metodologia, sequência de passos previsíveis ou um roteiro, para as atividades, ações e tarefas necessárias para o desenvolvimento de um software de alta qualidade. Uma metodologia de processo genérica possui cinco atividades metodológicas: comunicação, planejamento, modelagem, construção e entrega. Com base nestas atividades genéricas a engenharia de software oferece alguns modelos prescritivos para o desenvolvimento de software, sendo os principais: 
